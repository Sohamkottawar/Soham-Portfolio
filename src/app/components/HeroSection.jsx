...
const HeroSection = () => {
  return ( 
    ...
    />
                ...
                <div>
                    <button onClick={() => window.open('https://www.linkedin.com/in/sohamkottawar/', '_blank')}  className='px-1 py-1 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple-500 to-orange-400 hover:bg-slate-200 text-white'>
                        <span className='block bg-[121212] hover:bg-slate-800 rounded-full px-5 py-2'>Hire Me</span>
                    </button>
                    <button  onClick={() => window.open('https://drive.google.com/file/d/1-mcGDWoWKxAJVts0iUGuQUUpklc8R06C/view?usp=sharing', '_blank')} 
